 ...
 * @author lahvac
 */
public class DuplicateClassTest extends TestCase {

    public DuplicateClassTest(String name) {
        super(name);
    }
    ...
    public void testNPEDuplicatedClass() throws IOException {
        ...
        JavacTask ct = (JavacTask)tool.getTask(null, null, null, Arrays.asList("-bootclasspath",  bootPath, "-source", version, "-Xjcov", "-XDshould-stop.at=GENERATE"), null, Arrays.asList(new MyFileObject(code)));
