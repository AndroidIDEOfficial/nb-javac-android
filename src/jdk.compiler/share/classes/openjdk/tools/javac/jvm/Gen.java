...
import openjdk.tools.javac.tree.TreeInfo.PosKind;
...
import openjdk.tools.javac.jvm.Items.*;
...
import static openjdk.tools.javac.jvm.ByteCodes.*;
import static openjdk.tools.javac.jvm.CRTFlags.*;
 ...
 *************************************************************************/
    ...
    private void setTypeAnnotationPositions(int treePos) {
        ...
        for (Symbol s : new openjdk.tools.javac.model.FilteredMemberList(clazz.members())) {
