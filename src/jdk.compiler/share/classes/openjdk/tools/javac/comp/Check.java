...
import openjdk.tools.javac.code.Attribute.Compound;
...
import static openjdk.tools.javac.code.Flags.SYNCHRONIZED;
 ...
 **************************************************************************/
    ...
    // where
        private void warnDeferredUnchecked(final DiagnosticPosition pos, final Warning warnKey) {
            DiagnosticPosition prevPos = deferredLintHandler.setPos(pos);
            try {
                deferredLintHandler.report(new DeferredLintHandler.LintLogger() {
                    @Override
                    public void report() {
                        warnUnchecked(pos, warnKey);
                    }
                });
            } finally {
 ...
 **************************************************************************/
    ...
    void validateAnnotationTree(JCTree tree) {
        class AnnotationValidator extends TreeScanner {
            ...
            public void visitAnnotation(JCAnnotation tree) {
                if (tree.type != null && !tree.type.isErroneous() && tree.type.tsym.isAnnotationType()) {
    ...
    private void validateAnnotation(JCAnnotation a, JCTree declarationTree, Symbol s) {
        ...
        boolean isRecordField = (s.flags_field & RECORD) != 0 &&
                (declarationTree != null ? declarationTree.hasTag(VARDEF) : false) &&
                s.owner.kind == TYP;
