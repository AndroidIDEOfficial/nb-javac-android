...
import openjdk.tools.javac.api.Formattable.LocalizedString;
...
import openjdk.tools.javac.comp.Attr.ResultInfo;
import openjdk.tools.javac.comp.Check.CheckContext;
import openjdk.tools.javac.comp.DeferredAttr.AttrMode;
import openjdk.tools.javac.comp.DeferredAttr.DeferredAttrContext;
import openjdk.tools.javac.comp.DeferredAttr.DeferredType;
import openjdk.tools.javac.comp.Resolve.MethodResolutionContext.Candidate;
import openjdk.tools.javac.comp.Resolve.MethodResolutionDiagHelper.Template;
import openjdk.tools.javac.comp.Resolve.ReferenceLookupResult.StaticKind;
...
import openjdk.tools.javac.tree.JCTree.JCMemberReference.ReferenceKind;
...
import static openjdk.tools.javac.comp.Resolve.MethodResolutionPhase.*;
import static openjdk.tools.javac.tree.JCTree.Tag.*;
import static openjdk.tools.javac.util.Iterators.createCompoundIterator;
 ...
 ****************************************************************************/
     ...
     * the resulting symbol is delegated to an helper class {@link openjdk.tools.javac.comp.Resolve.ReferenceChooser}.
     *
     ...
     * of the lookup (see {@link openjdk.tools.javac.comp.Resolve.ReferenceLookupResult.StaticKind}).
     */
