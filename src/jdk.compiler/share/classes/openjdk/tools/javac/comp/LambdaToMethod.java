...
import openjdk.tools.javac.code.Symbol.MethodHandleSymbol;
import openjdk.tools.javac.code.Types.SignatureGenerator.InvalidSignatureException;
import openjdk.tools.javac.jvm.PoolConstant.LoadableConstant;
...
import openjdk.tools.javac.code.Symbol.DynamicMethodSymbol;
...
import openjdk.tools.javac.comp.LambdaToMethod.LambdaAnalyzerPreprocessor.*;
import openjdk.tools.javac.comp.Lower.BasicFreeVarCollector;
...
import static openjdk.tools.javac.comp.LambdaToMethod.LambdaSymbolKind.*;
            ...
            Symbol translate(final Symbol sym, LambdaSymbolKind skind) {
                ...
                switch (skind) {
                    ...
                    case LOCAL_VAR:
                        ...
                        // Because method openjdk.tools.javac.jvm.Code.fillExceptionParameterPositions and
                        // openjdk.tools.javac.jvm.Code.fillLocalVarPosition would use it.
