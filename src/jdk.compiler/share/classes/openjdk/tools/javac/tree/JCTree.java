 ...
 *
 * <p>Except for the methods defined by openjdk.source, the only
 ...
 * Tree.
 *
 * <p>To avoid ambiguities with the Tree API in openjdk.source all sub
...
public abstract class JCTree implements Tree, Cloneable, DiagnosticPosition {
    ...
    public static class JCImport extends JCTree implements ImportTree {
        ...
        public openjdk.tools.javac.code.Scope importScope;
    ...
    public static class JCClassDecl extends JCStatement implements ClassTree {
        ...
        protected JCClassDecl(JCModifiers mods,
                ...
                List<JCTree> defs,
                ClassSymbol sym) {
            this(mods, name, typarams, extending, implementing, List.nil(), defs, sym);
        }
    ...
    public static class JCCase extends JCStatement implements CaseTree {
        ...
        protected JCCase(CaseKind caseKind, List<JCCaseLabel> labels,
            ...
            this.labels = labels;
            this.pats = labels.stream().filter(p -> p instanceof JCExpression).map(p -> (JCExpression) p).collect(List.collector());
            this.stats = stats;
            this.body = body;
        }
        @Override
    ...
    public static class JCModifiers extends JCTree implements openjdk.source.tree.ModifiersTree {
        public long flags;
        public List<JCAnnotation> annotations;
    ...
    public static class JCAnnotatedType extends JCExpression implements openjdk.source.tree.AnnotatedTypeTree {
        // type annotations
        public List<JCAnnotation> annotations;
