...
import openjdk.source.doctree.DocTree.Kind;
...
import openjdk.source.util.DocTreeFactory;
import openjdk.tools.javac.api.JavacTrees;
import openjdk.tools.javac.parser.ParserFactory;
import openjdk.tools.javac.parser.ReferenceParser;
import openjdk.tools.javac.parser.Tokens.Comment;
import openjdk.tools.javac.tree.DCTree.DCAttribute;
import openjdk.tools.javac.tree.DCTree.DCAuthor;
import openjdk.tools.javac.tree.DCTree.DCComment;
import openjdk.tools.javac.tree.DCTree.DCDeprecated;
import openjdk.tools.javac.tree.DCTree.DCDocComment;
import openjdk.tools.javac.tree.DCTree.DCDocRoot;
import openjdk.tools.javac.tree.DCTree.DCDocType;
import openjdk.tools.javac.tree.DCTree.DCEndElement;
import openjdk.tools.javac.tree.DCTree.DCEntity;
import openjdk.tools.javac.tree.DCTree.DCErroneous;
import openjdk.tools.javac.tree.DCTree.DCHidden;
import openjdk.tools.javac.tree.DCTree.DCIdentifier;
import openjdk.tools.javac.tree.DCTree.DCIndex;
import openjdk.tools.javac.tree.DCTree.DCInheritDoc;
import openjdk.tools.javac.tree.DCTree.DCLink;
import openjdk.tools.javac.tree.DCTree.DCLiteral;
import openjdk.tools.javac.tree.DCTree.DCParam;
import openjdk.tools.javac.tree.DCTree.DCProvides;
import openjdk.tools.javac.tree.DCTree.DCReference;
import openjdk.tools.javac.tree.DCTree.DCReturn;
import openjdk.tools.javac.tree.DCTree.DCSee;
import openjdk.tools.javac.tree.DCTree.DCSerial;
import openjdk.tools.javac.tree.DCTree.DCSerialData;
import openjdk.tools.javac.tree.DCTree.DCSerialField;
import openjdk.tools.javac.tree.DCTree.DCSince;
import openjdk.tools.javac.tree.DCTree.DCStartElement;
import openjdk.tools.javac.tree.DCTree.DCSummary;
import openjdk.tools.javac.tree.DCTree.DCSystemProperty;
import openjdk.tools.javac.tree.DCTree.DCText;
import openjdk.tools.javac.tree.DCTree.DCThrows;
import openjdk.tools.javac.tree.DCTree.DCUnknownBlockTag;
import openjdk.tools.javac.tree.DCTree.DCUnknownInlineTag;
import openjdk.tools.javac.tree.DCTree.DCUses;
import openjdk.tools.javac.tree.DCTree.DCValue;
import openjdk.tools.javac.tree.DCTree.DCVersion;
...
public class DocTreeMaker implements DocTreeFactory {
    ...
    protected DocTreeMaker(Context context) {
        ...
        sentenceBreakTags = new HashSet<>(Arrays.asList("H1", "H2", "H3", "H4", "H5", "H6", "PRE", "P"));
    }
    ...
    public DCReference newReferenceTree(String signature, JCTree qualExpr, Name member, List<JCTree> paramTypes) {
        return newReferenceTree(signature, null, qualExpr, member, paramTypes);
    }
