...
import static openjdk.tools.javac.main.Option.ChoiceKind.*;
import static openjdk.tools.javac.main.Option.OptionGroup.*;
import static openjdk.tools.javac.main.Option.OptionKind.*;
...
public enum Option {
    ...
    XDOCLINT_CUSTOM("-Xdoclint:", "opt.Xdoclint.subopts", "opt.Xdoclint.custom", EXTENDED, BASIC) {
        ...
        public boolean matches(String option) {
            ...
            //return new DocLint().isValidOption(
                    //option.replace(XDOCLINT_CUSTOM.primaryName, DocLint.XMSGS_CUSTOM_PREFIX));
        }
