...
import openjdk.tools.javac.util.GraphUtils.DependencyKind;
import openjdk.tools.javac.util.GraphUtils.DotVisitor;
import openjdk.tools.javac.util.GraphUtils.NodeVisitor;
