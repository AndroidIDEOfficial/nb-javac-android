...
import openjdk.tools.javac.code.Type.CapturedType;
import openjdk.tools.javac.code.Type.ClassType;
import openjdk.tools.javac.code.Type.ErrorType;
import openjdk.tools.javac.code.Type.ForAll;
import openjdk.tools.javac.code.Type.MethodType;
import openjdk.tools.javac.code.Type.PackageType;
import openjdk.tools.javac.code.Type.TypeVar;
import openjdk.tools.javac.code.Type.UndetVar;
import openjdk.tools.javac.code.Type.Visitor;
import openjdk.tools.javac.code.Type.WildcardType;
import openjdk.tools.javac.code.TypeAnnotationPosition.TypePathEntry;
import openjdk.tools.javac.code.TypeAnnotationPosition.TypePathEntryKind;
import openjdk.tools.javac.code.Symbol.VarSymbol;
import openjdk.tools.javac.code.Symbol.MethodSymbol;
import openjdk.tools.javac.code.Type.ModuleType;
import openjdk.tools.javac.code.TypeMetadata.Entry.Kind;
...
public class TypeAnnotations {
    ...
    private class TypeAnnotationPositions extends TreeScanner {
        ...
        // {@link openjdk.tools.javac.parser.JavacParser.insertAnnotationsToMostInner(JCExpression, List<JCTypeAnnotation>, boolean)}
                ...
                final TypeAnnotationPosition pos)
        {
            ...
            if (type.hasTag(TypeTag.TYPEVAR)) {
                ...
                // UnionClassType uct = (openjdk.tools.javac.code.Type.UnionClassType)type;
                         ...
                         ListBuffer<TypePathEntry> location)
        {
            ...
            // openjdk.tools.javac.jvm.Gen.setTypeAnnotationPositions(int)
