...
import openjdk.tools.javac.code.Symbol.RootPackageSymbol;
import openjdk.tools.javac.code.Symbol.TypeSymbol;
import openjdk.tools.javac.code.Symbol.VarSymbol;
import openjdk.tools.javac.code.Type.BottomType;
import openjdk.tools.javac.code.Type.ClassType;
import openjdk.tools.javac.code.Type.ErrorType;
import openjdk.tools.javac.code.Type.JCPrimitiveType;
import openjdk.tools.javac.code.Type.JCVoidType;
import openjdk.tools.javac.code.Type.MethodType;
import openjdk.tools.javac.code.Type.UnknownType;
import openjdk.tools.javac.code.Types.UniqueType;
        ...
        unnamedModule = new ModuleSymbol(names.empty, null) {
                {
                    ...
                    openjdk.tools.javac.code.Directive.RequiresDirective d =
                            new openjdk.tools.javac.code.Directive.RequiresDirective(java_base,
                                    EnumSet.of(openjdk.tools.javac.code.Directive.RequiresFlag.MANDATED));
                    requires = List.of(d);
                }
                @Override
