...
import openjdk.tools.javac.code.Types.TypeMapping;
import openjdk.tools.javac.code.Types.UniqueType;
import openjdk.tools.javac.comp.Infer.IncorporationAction;
...
//where
    ...
    public static class MethodType extends Type implements ExecutableType, openjdk.tools.javac.jvm.PoolConstant.LoadableConstant {
