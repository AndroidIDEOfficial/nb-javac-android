...
import openjdk.tools.sjavac.comp.dependencies.NewDependencyCollector;
import openjdk.tools.sjavac.comp.dependencies.PublicApiCollector;
import openjdk.tools.sjavac.server.CompilationSubResult;
                ...
                if (explicitJFOs.size() > 0) {
                    ...
                    JavacTaskImpl task =
                            (JavacTaskImpl) compiler.getTask(new PrintWriter(stderrLog),
                                                             ...
                                                             explicitJFOs,
                                                             context);
                    sfm.setSymbolFileEnabled(!openjdk.tools.javac.util.Options.instance(context).isSet("ignore.symbol.file"));
