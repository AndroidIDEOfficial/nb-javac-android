...
import openjdk.tools.sjavac.comp.PubapiVisitor;
import openjdk.tools.sjavac.comp.SmartFileManager;
...
public class PubApiExtractor {
    ...
    public PubApiExtractor(Options options) {
        JavacTool compiler = openjdk.tools.javac.api.JavacTool.create();
        fileManager = new SmartFileManager(compiler.getStandardFileManager(null, null, null));
        context = new openjdk.tools.javac.util.Context();
